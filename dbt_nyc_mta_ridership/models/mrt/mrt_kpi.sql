...
select
  ...
  (
    sum(subways_total_estimated_ridership)
  + sum(buses_total_estimated_ridership)
  + sum(lirr_total_estimated_ridership)
  + sum(metro_north_total_estimated_ridership)
  + sum(access_a_ride_total_scheduled_trips)
  + sum(bridges_and_tunnels_total_traffic)
  + sum(staten_island_railway_total_estimated_ridership)
  ) as sum_total_rides,
